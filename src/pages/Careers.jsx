...
const Careers = () => {
    ...
    const jobs = [
        {
            ...
            description: `
        We're looking for a passionate Frontend Developer to join our growing tech team at JOSAM. 
      ...
      `,
        },
        {
            ...
            description: `
        Help us deliver fashion faster! As a Warehouse Associate, you'll manage inventory, pack orders, and coordinate shipments.
    ...
    return (
        <main className="bg-white">
            {/* Hero Section */}
            <section className="py-24 px-6 text-center bg-gradient-to-br from-indigo-50 via-white to-purple-50">
                <div className="max-w-4xl mx-auto">
                    <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6">
                        Join the JOSAM Team
                    </h1>
                    <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed">
                        Be part of a dynamic, fast-growing fashion brand shaping the future of menswear in Egypt.
                    </p>
                    <a
                        href="#openings"
            ...
            <section className="py-20 px-6">
                <div className="max-w-6xl mx-auto text-center mb-16">
                    <h2 className="text-3xl font-bold text-gray-900">Why Work at JOSAM?</h2>
                    <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
                        We believe great people build great brands. Here’s what makes JOSAM different.
                    </p>
                </div>
                                ...
                                <form onSubmit={handleSubmitApplication} className="space-y-6">
                                    ...
                                    <div className="flex gap-4 pt-4">
                                        <button
                                            ...
                                            className={`px-6 py-3 bg-primary text-white rounded-lg hover:bg-indigo-700 transition ${isSubmitting ? "opacity-80 cursor-not-allowed" : ""
                                                }`}
                                        >
            ...
            <section className="py-20 px-6 bg-gradient-to-r from-primary to-indigo-700 text-white text-center">
                <div className="max-w-3xl mx-auto">
                    ...
                    <button
                        onClick={() => window.location.href = "mailto:careers@josam.com"}
